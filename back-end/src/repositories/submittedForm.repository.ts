...
import { ISubmittedFormRepository } from "./db/submittedForm.dbRepository";
...
//     ): Promise<SubmittedForm | undefined> {
//         return this.submmitedFormRepo.find(
//             (x) => x.email === submittedFormEmail
//         );
//     }
...
//     ): Promise<boolean> {
//         try {
//             const readSubmittedForm = await this.readSubmittedFormById(
//                 submittedForm.id
//             );
